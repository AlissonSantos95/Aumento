...
class Aumento:
    ...
    def SalvarPickle(self):
       msg=tk.messagebox.askyesno("Load", "Carregar Salvos?")
       if (msg):
         dump = pickle.load(open("dump.txt", "rb"))
    ...
    def __init__(self, top=None):
        ...
        self.Export_TXT.configure(text='''Carregar''')
        self.Export_TXT.configure(command=self.exportar)
        ...
        self.SalvarB = tk.Button(top)
        self.SalvarB.place(relx=0.292, rely=0.561, height=24, width=80)
        self.SalvarB.configure(activebackground="#ececec")
        self.SalvarB.configure(activeforeground="#000000")
        self.SalvarB.configure(background="#d9d9d9")
        self.SalvarB.configure(disabledforeground="#a3a3a3")
        self.SalvarB.configure(foreground="#000000")
        self.SalvarB.configure(highlightbackground="#d9d9d9")
        self.SalvarB.configure(highlightcolor="black")
        self.SalvarB.configure(pady="0")
        self.SalvarB.configure(text='''Salvar''')
        self.SalvarB.configure(command=self.SalvarPickle)
        #self.Salv.configure(command= 
